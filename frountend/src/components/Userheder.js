import { Stack ,Flex,Box,Text,Spacer,Image,InputGroup,Input,InputLeftElement,Select,Tooltip,FormControl,
    FormLabel,InputRightElement,useToast,
    Popover,
    PopoverTrigger,
    PopoverContent,
    PopoverArrow,
...
import { BellIcon,ChevronDownIcon ,DeleteIcon,ViewIcon,ViewOffIcon} from '@chakra-ui/icons'
...
return (
  ...
  <Stack w="100%" h="106px" margin="0px" padding="0px" > 
     <Flex  margin="0" padding="0" bgColor='#020B2C'  w="100%" h="40px" >
        <Text fontSize="18" fontWeight="bold" p={2} color="blue" ml="5px" >Hi {profname} ,</Text>
        <Spacer/>
...
{/* *****************************************my E-learn**************************************** */}
        ...
        <Menu>
    <MenuButton  textColor="blue" mr="40px" rightIcon={<ChevronDownIcon />}>
    My E-learn
  </MenuButton>
  <MenuList>
    <MenuItem minH='20px'>
          ...
          <form method="post" onSubmit={changepassword} >
                  ...
                  <InputGroup  borderColor="black" >
                          ...
                          <Input
                            ...
                            <Button onClick={onClose} ml="5px"mt="40px">Close</Button>                      
...
{/* ********************************************************************************************************** */}
     ...
     <Flex w="100%" h="55px" >
        <Box w="21%" h="48"/>
        <Image src="./images/logo.png" w="100px" h="50px" marginRight="20px" onClick={esolimage} />
        ...
        <Tooltip hasArrow label="Search Your Teacher" bg="blue.600" >
            <InputGroup  >
                ...
                />
                <Input type="text"  color="#718096" placeholder="Enter your Teacher" variant="unstyled"  margin="1.5" value={searchbody} onChange={({target}) => setSearchbody(target.value)}/>
            </InputGroup>
            </Tooltip>
        </Box>
        ...
        <Tooltip hasArrow label="Select Subject" bg="blue.600" >
            <Select placeholder="All Subject" color="#718096" onChange={(e) => setSubject(e.target.value)} variant="unstyled" margin="1.5">
        ...
        <Box bg="blue"  h="48px" w="170px"  marginTop="5px" marginLeft="5px" textAlign="center" onClick={search}>
